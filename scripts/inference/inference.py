...
sys.path.append('/home/cxu-serve/p62/ytang37/projects/Caption-Anything-2/TRACE/')
sys.path.append('/home/cxu-serve/p62/ytang37/projects/Caption-Anything-2/TRACE/trace')
print(sys.path)
...
def inference():
    # Video Inference
    paths = ['/home/cxu-serve/p62/ytang37/projects/Caption-Anything-2/samurai/demo.mp4']
